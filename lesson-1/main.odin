...
main :: proc() {
	...
	color_1_loc := rl.GetShaderLocation(shader, "color1")
	color_2_loc := rl.GetShaderLocation(shader, "color2")
	...
	for !rl.WindowShouldClose() {
		...
		rl.SetShaderValue(shader, color_1_loc, raw_data(&color1), rl.ShaderUniformDataType.VEC4)
		rl.SetShaderValue(shader, color_2_loc, raw_data(&color2), rl.ShaderUniformDataType.VEC4)
